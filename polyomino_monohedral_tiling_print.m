function [ r_label, r_color ] = polyomino_monohedral_tiling_print ( ...
  r_shape, p_shapes, x, label );

%*****************************************************************************80
%
%% polyomino_monohedral_tiling_print() prints a monohedral tiling.
%
%  Discussion:
%
%    Change the internal parameter "COLOR_CHOICE" to specify how to 
%    set the numbers that identify each polyomino component of the tiling.
%
%    Change the internal parameter "SHOW_ZERO" to specify whether zero 
...
%    polyominoe.  The matrix is "top-left tight", that is, the polyomino 
%    is stored with a 1 in the first row, a 1 in the first column, but with
%    trailing rows and columns of zeros allowed.
%
...
%
%  Index the cells in R which are set to 1.
%
...
%  R_LABEL replaces each 1 by the index of the polyomino variant which
%  covers it.
%
