function [p_shapes, r_shape, m, n, f] = LPmake_polyominoes_Figure3 ()

%*****************************************************************************80
%
%% LPmake_polyominoes_Figure3 () creates the LP file for Figure 3 in the reference below.
%
%  Discussion:
%
...
%    tile with polyominoes (not pariominoes). The actual figure 3 in the
...
%
%    integer R_SHAPE(18,24): a binary matrix that describes the region.
%
...
%
  filename ='Figure3_polyominoes.lp';
  label = '\ LP file for Figure3 in the pariomino paper (no colouring techniques).';
  polyomino_lp_write ( filename, label, m, n, a, b );
  
  fprintf ( 1, '\n' );
  fprintf ( 1, '  LPmake_polyominoes_Figure3 created the LP file "%s"\n', filename );
